...
class GallerySlider extends _react.default.PureComponent {
  ...
  calculateOffset() {
    ...
    this.setState({
      offsetLeft: constantOffset - (columnWidth + columnGutter) * activeImage
    });
  }
  ...
  getImages(image, index) {
    ...
    return /*#__PURE__*/ _react.default.createElement('div', {
      ...
      style: this.getImagesStyles({
        src: image,
        width: isActive ? activeWidth : columnWidth
      }),
      key: index,
      id: index
    });
  ...
  render() {
    ...
    return /*#__PURE__*/ _react.default.createElement(
      ...
      null,
      loading !== null && loading !== void 0 ? loading : loaderElement,
      /*#__PURE__*/ _react.default.createElement(
        'div',
        {
          className: (0, _classnames.default)(
            _indexModule.default.galleryWrapper,
            loading && _indexModule.default.hidden
          ),
          style: {
        ...
        /*#__PURE__*/ _react.default.createElement(
          ...
          /*#__PURE__*/ _react.default.createElement('div', {
            className: (0, _classnames.default)(
              _indexModule.default.galleryImage,
